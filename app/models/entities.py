...
class Empresa(TimestampMixin, Base):
    ...
    assinatura_ends_at: Mapped[date | None] = mapped_column(Date)
...
class CaixaInicial(TimestampMixin, Base):
    __tablename__ = "caixas_iniciais"
    __table_args__ = (UniqueConstraint("empresa_id", "mes"),)
